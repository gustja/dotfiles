# Generated by Powerlevel10k configuration wizard on 2026-06-03.
# Safe and fully optimized for Nerd Fonts.
...
(() {
  ...
  # Zsh nospiešanas stils un ikonu režīms (Nerd Fonts obligāts)
  typeset -g POWERLEVEL9K_MODE=nerdfont-v3
  typeset -g POWERLEVEL9K_ICON_PADDING=moderate

  # Vizuālais stils: Rainbow (Krāsainie segmenti)
  ...
  # Kreisās puses elementi (Lietotājs, Mape, Git stāvoklis)
  ...
  # Labās puses elementi (Tikai paši svarīgākie statusi)
  ...
  # Komandu izpildes laiks (ja ilgāk par 3 sekundēm)
  ...
  # Prompt ievades simbola stils (Zaļš, ja viss OK, Sarkans ja kļūda)
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=76
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=196
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='❯'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='❯'

  # Segmentu savienojumu vizuālie efekti (Trijstūri)
